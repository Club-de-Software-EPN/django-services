...
import neat
import os
from modules.PygameDrawerFlappyBirds import PygameDrawer
from modules.models.Bird import Bird
from modules.models.Pipe import Pipe
from modules.models.Base import Base
from modules.ParametersFlappyBirds import Parameters
...
if __name__ == '__main__':
    ...
    configuration_neat_path = os.path.join(local_directory, "data", "configuration_neat_flappy_bird.txt")
